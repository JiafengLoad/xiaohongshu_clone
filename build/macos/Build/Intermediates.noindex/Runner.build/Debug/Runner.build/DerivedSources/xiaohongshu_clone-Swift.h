...
#ifndef XIAOHONGSHU_CLONE_SWIFT_H
#define XIAOHONGSHU_CLONE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="xiaohongshu_clone",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC17xiaohongshu_clone11AppDelegate")
...
SWIFT_CLASS("_TtC17xiaohongshu_clone17MainFlutterWindow")
