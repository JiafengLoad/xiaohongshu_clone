...
import '../../../../CommonTool/VideoPlayerWidget.dart';
import '../../../detail/page/XhsImageDetailPage.dart';
import '../../model/XhsNoteItem.dart';

class XshAttentionPage extends StatefulWidget {
  const XshAttentionPage({super.key});

  @override
  State<XshAttentionPage> createState() => _XshAttentionPageState();
}

class _XshAttentionPageState extends State<XshAttentionPage>
    with AutomaticKeepAliveClientMixin {
  @override
  bool get wantKeepAlive => true;

  late final List<XhsNoteItem> noteList;
  ...
  // 👇 自动区分：图片卡片 / 视频卡片
  Widget _buildNoteCard(XhsNoteItem note) {
    switch (note.type) {
      case NoteType.image:
  ...
  // 👇 图片卡片
  Widget _imageCard(XhsNoteItem note) {
    return Container(
  ...
  // 👇 视频卡片（可播放、带暂停/开始）
  Widget _videoCard(XhsNoteItem note) {
  ...
  // 👇 底部通用：标题、头像、点赞
  Widget _buildBottomInfo(XhsNoteItem note) {
    return Padding(
  ...
  void _openXhsDetailPage(BuildContext context, XhsNoteItem item) {
